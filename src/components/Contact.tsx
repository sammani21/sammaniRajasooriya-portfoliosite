...
const Contact = () => {
  ...
  const handleSend = (e: any) => {
    ...
    emailjs
        .send(
          "service_xb59hb7", // Replace with your EmailJS service ID
          "template_oea499b", // Replace with your EmailJS template ID
          templateParams,
          "w2KXkmt43oE1WWk-D" // Replace with your EmailJS user ID
        )
        .then(
          (response) => {
